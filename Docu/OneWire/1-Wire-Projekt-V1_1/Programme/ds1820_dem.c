...
/*                        Programm unter Verwendung der ´ow´- und ´ds1820´-APIs           */
/*                                                                                        */
/*                                                                                        */
/*     Autoren:           B.v.B. / P.G.                                                   */
/*                                                                                        */
...
void ds1820_get_temp(void)
{
    ...
    while (1)
    {
        // Temperatur messen und Scratch Pad des DS1820 auslesen
...
void bus_demo(void)
{
    ...
    while(1)
    {
        ...
        for (i=0; i<5; i++)
        {
            // Temperatur messne und Scratch Pad des DS1820 auslesen
            ds1820_rd_temp(i);            // i = Stellung des Slaves in Matrix ds180_mat
