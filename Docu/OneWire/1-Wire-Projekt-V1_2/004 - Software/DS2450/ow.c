...
void ow_fem(unsigned char fe_nr)
{
    ...
    switch(fe_nr)
    {
        case 20:    printf("Kein Presence beim Schreiben in eine Seite (1) !"); break;
        case 21:    printf("Fehler beim Schreiben - Ruecklesen !"); break;
        case 22:    printf("Kein Presence beim Schreiben in eine Seite (2) !"); break;
        case 23:    printf("Kein Presence beim Lesen aus einer Seite (1) !"); break;
        case 24:    printf("Kein Presence beim Lesen aus einer Seite (2) !"); break;
        case 25:    printf("Kein Presence beim Schreiben in Page 3 (Init-Anf.) !"); break;
        case 26:    printf("Fehler beim Rücklesen von Page 3 (Init) !"); break;
        case 27:    printf("Kein Presence beim Start Convert (Anfang) !"); break;
        case 28:    printf("Kein Presence beim Start Convert (Ende) !"); break;
        case 29:    printf("Kein Presence beim Schreiben in Page 3 (Init-Ende) !"); break;
