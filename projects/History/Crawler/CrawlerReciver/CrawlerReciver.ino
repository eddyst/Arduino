...
// reliability, so you should onMV use RH_NRF24  if you do not need the higher
...
RH_NRF24 nrf24(9,10);
// RH_NRF24 nrf24(8, 7); // use this to be electricalMV compatible with Mirf
