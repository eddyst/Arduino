...
unsigned long estTimer2::time_units;
void (*estTimer2::func)();
volatile unsigned long estTimer2::count;
volatile char estTimer2::overflowing;
volatile unsigned int estTimer2::tcnt2;

void estTimer2::set(unsigned long ns, void (*f)()) {
 ...
 */
void estTimer2::set(unsigned long units, double resolution, void (*f)()) {
	float prescaler = 0.0;
