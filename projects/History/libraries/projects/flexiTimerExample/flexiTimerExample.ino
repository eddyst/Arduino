...
void flash()
{
  ...
  output = !output;
//if (!output) FlexiTimer2::set(500, 1.0/1000, flash); // call every 500 1ms "ticks"
//else         FlexiTimer2::set(100, 1.0/1000, flash); // call every 500 1ms "ticks"
...
//  FlexiTimer2::set(50000, 1.0/1000000, flash); // call every 500 1ms "ticks"
